...
- Start with walk/run intervals (e.g., "Walk/Run: 20min (1min jog, 90s walk) x 8 at RPE 3-4")
...
- Keep intensity very low (RPE 2-4) for first 6 weeks
`
      : '';
...
- Week ${numberOfWeeks} (race week - FINAL WEEK): Sharp taper - reduce volume by 50-60%
  - Include 1-2 short easy runs (3-5km at RPE 2-3)
...
- "Walk/Run: Xmin (Xmin jog, Xmin walk) x N at RPE 3-4" - for beginners alternating walk and jog (e.g., "Walk/Run: 20min (1min jog, 90s walk) x 8 at RPE 3-4")
