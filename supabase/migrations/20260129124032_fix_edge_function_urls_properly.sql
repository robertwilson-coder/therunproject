/*
  # Fix Edge Function URLs in Trigger Functions

  1. Changes
    - Update trigger functions to use hardcoded Supabase URL
    - Fix welcome email trigger function
    - Fix Discord notification trigger function
  
  2. Notes
    - The JWT iss field returns "supabase" not the full URL
    - We need to hardcode the URL for the project
    - Using the project reference from env to construct URL
*/
