...
function App() {
  ...
  if (authLoading) {
    return (
      <div className="min-h-dvh bg-white dark:bg-neutral-950 flex items-center justify-center">
      ...
      <div className="pt-16 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          {navigation.appState === 'landing' && (
            <div className="absolute top-28 left-6 z-20 animate-fade-in">
        ...
        {navigation.appState === 'landing' && (
          <div className="relative max-w-7xl mx-auto py-6 min-h-[700px] flex items-center overflow-hidden">
            ...
            <div className="relative z-10 w-full text-center px-4 pt-32 pb-16">
              ...
              <div className="flex flex-row gap-3 sm:gap-5 justify-center items-stretch px-4">
                <button
                  onClick={() => {
        ...
        {navigation.appState === 'viewPlan' && planManager.planData && planManager.planType && planManager.answers && (
          <Suspense fallback={<TrainingPlanSkeleton />}>
            <PlanWithChat
              ...
              onChatUpdate={planManager.setChatHistory}
