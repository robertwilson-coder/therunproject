...
export type TrainingFocus = 'durability' | 'performance';
...
export interface RunnerAnswers {
  ...
  calibrationChoice?: 'race_result' | 'calibration_test' | 'skip';
...
export interface PlanPauseSnapshot {
...
export interface TrainingPlan {
  ...
  pause_week_index?: number | null;
  pause_structural_volume?: number | null;
  pause_long_run_target?: number | null;
