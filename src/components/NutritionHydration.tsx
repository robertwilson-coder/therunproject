...
export function NutritionHydration({ onClose }: NutritionHydrationProps) {
  ...
  const addDuringRunItem = () => {
    setStrategyForm({
      ...strategyForm,
      during_run_items: [...strategyForm.during_run_items, { item: '', timing: '', mile_marker: undefined }]
    });
  };
                ...
                {showGuide && (
                  <div className="p-5 border-t border-blue-200 dark:border-blue-700 space-y-5 text-sm text-gray-700 dark:text-gray-300">
                    <div>
                      ...
                      <p className="ml-8 text-gray-600 dark:text-gray-400 italic">Example: Try a banana 30min before your Tuesday easy run, or test a gel at mile 3 of your Thursday recovery run.</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="ml-8 text-gray-600 dark:text-gray-400 italic">Example: If oatmeal worked well before easy runs, try it before your Saturday long run. Test taking a gel every 45 minutes during your 10+ mile runs.</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="ml-8 text-gray-600 dark:text-gray-400 italic">Example: For a half marathon, your 10-12 mile long runs are perfect dress rehearsals. Eat your planned breakfast at the same time, carry the same products, and practice your fueling schedule.</p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border-2 border-blue-300 dark:border-blue-600">
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 ml-3">During: Gel at mile 6-7, water at every station</p>
                        </div>
                        <div>
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 ml-3">During: 30-60g carbs/hr (gel every 45min or chews every 30min), water at every station</p>
                        </div>
                      </div>
                    </div>
                      ...
                      {strategyForm.during_run_items.map((item, idx) => (
                        <div key={idx} className="grid grid-cols-12 gap-2">
                          ...
                          <input
                            type="number"
                            placeholder="Mile"
                            value={item.mile_marker || ''}
                            onChange={(e) => updateDuringRunItem(idx, 'mile_marker', e.target.value ? parseFloat(e.target.value) : undefined)}
                            ...
                            <div>
                              ...
                              <ul className="ml-4 mt-1 space-y-1">
                                {strategy.during_run_items.map((item, idx) => (
                                  <li key={idx} className="text-gray-600 dark:text-gray-400">
                                    {item.item} {item.mile_marker ? `at mile ${item.mile_marker}` : ''}
                                  </li>
                                ))}
                              </ul>
                            </div>
                ...
                <form onSubmit={handleSaveLog} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="e.g., Banana 30min before, Gel at mile 6, Sports drink every 15min"
