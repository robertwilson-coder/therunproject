                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 text-center mx-4">
                          <div
                            className={`text-sm md:text-base leading-relaxed font-medium ${isCompleted ? 'line-through' : ''} ${isBeforeStart ? 'text-gray-500 italic' : ''}`}
                            dangerouslySetInnerHTML={{ __html: renderMarkdown(activity) }}
                          />
                          {trainingPaces && !isRestDay && !activity.toLowerCase().includes('active recovery') && (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="text-center mt-2">
                    <span className="text-2xl font-bold text-blue-600">{workoutDistance.toFixed(1)} km</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-center mt-2">
                    <span className="text-2xl font-bold text-blue-600">{workoutDuration} min</span>
                  </div>
                </div>
