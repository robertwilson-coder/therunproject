  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-start justify-center z-50 p-4 overflow-y-auto animate-fade-in">
      <div className="relative max-w-3xl w-full my-8 animate-scale-in">
        ...
        <div className="relative bg-gradient-to-br from-neutral-900 via-teal-950 to-neutral-900 rounded-2xl border-2 border-teal-400/50 shadow-2xl shadow-teal-500/50 overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-400"></div>

          <div className="relative p-8">
            <button
              onClick={onClose}
              className="absolute top-6 right-6 text-neutral-500 hover:text-white transition-colors hover:scale-110 hover:rotate-90"
            >
              <X className="w-7 h-7" />
            </button>
            ...
            <div className="mb-8">
              ...
              <h2 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-cyan-300 to-blue-300 mb-3">
                Record Test Data
              </h2>

              <div className="flex items-center gap-3 mb-4">
                <div className="flex-1 h-px bg-gradient-to-r from-teal-500/50 to-transparent"></div>
                <p className="text-teal-300 font-semibold text-sm uppercase tracking-wide">
              ...
              <div className="relative bg-gradient-to-br from-amber-500/10 to-orange-500/10 border-2 border-amber-400/40 rounded-xl p-5 mb-8 shadow-lg shadow-amber-500/20">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-amber-200 font-bold text-sm mb-2 uppercase tracking-wide">Critical Instructions</p>
            ...
            <div className="space-y-6">
              <div className="bg-teal-500/5 border-2 border-teal-400/30 rounded-xl p-5 shadow-lg">
                <h3 className="text-base font-black text-teal-300 mb-4 uppercase tracking-wide flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="bg-neutral-900/50 rounded-lg p-3 border border-teal-500/20">
                    <label className="text-xs font-bold text-teal-400 mb-2 block uppercase tracking-wider">
                      Work Duration *
                    </label>
                    <div className="flex items-baseline gap-2">
                      <input
                        ...
                        className="input-field flex-1 text-xl font-bold text-teal-300 bg-neutral-950 border-teal-500/50 focus:border-teal-400"
                        placeholder="0.0"
                      />
                      <span className="text-sm font-semibold text-teal-400">minutes</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-neutral-900/50 rounded-lg p-3 border border-teal-500/20">
                    ...
                    <div className="flex items-baseline gap-2">
                      <input
                        ...
                        placeholder="0.00"
                      />
                      <span className="text-sm font-semibold text-teal-400">km</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-neutral-900/50 rounded-lg p-3 border border-teal-500/20">
                  ...
                  <div className="flex gap-3 items-center">
                    <div className="flex-1">
                      <label className="text-xs text-teal-400/70 mb-1 block font-semibold uppercase">Minutes</label>
                      <input
                        type="text"
                        inputMode="numeric"
                        ...
                        className="input-field w-full text-xl font-bold text-center bg-neutral-950 border-teal-500/50 focus:border-teal-400 text-white"
                        placeholder="4"
                      />
                    </div>
                    <div className="text-xl font-black text-teal-400 mt-5">:</div>
                    <div className="flex-1">
                      <label className="text-xs text-teal-400/70 mb-1 block font-semibold uppercase">Seconds</label>
                      <input
                        type="text"
                        inputMode="numeric"
                    ...
                    <div className="text-sm text-teal-400 font-bold mt-5">min/km</div>
                  </div>
                </div>

                <div className="bg-neutral-900/50 rounded-lg p-4 border border-teal-500/20">
                  <label className="text-xs font-bold text-teal-400 mb-2 block uppercase tracking-wider">
                  ...
                  <div className="space-y-2">
                    {lapSplits.map((split, index) => (
                      <div key={index} className="flex items-center gap-2">
                        <span className="text-xs text-teal-400 font-bold w-16">KM {index + 1}:</span>
                        <input
                          type="text"
                          value={split}
                          onChange={(e) => {
                          ...
                          placeholder="5:30"
                          className="input-field flex-1 text-base font-mono bg-neutral-950 border-teal-500/50 focus:border-teal-400 text-white"
                        />
                        <button
                          type="button"
                          onClick={() => {
                    ...
                    <button
                      ...
                      className="text-sm text-teal-400 hover:text-teal-300 font-bold mt-2 flex items-center gap-2 px-3 py-2 bg-teal-500/10 rounded hover:bg-teal-500/20 transition-colors"
                    >
              ...
              <div className="bg-cyan-500/5 border-2 border-cyan-400/30 rounded-xl p-5 shadow-lg">
                <h3 className="text-base font-black text-cyan-300 mb-1 uppercase tracking-wide flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
                  Performance Analysis
                </h3>
                <p className="text-xs text-cyan-300/60 mb-4">How did your pace change during the effort?</p>

                <div className="space-y-4">
                  <div className="bg-neutral-900/50 rounded-lg p-4 border border-cyan-500/20">
                    <label className="text-xs font-bold text-cyan-400 mb-2 block uppercase tracking-wider">
                    ...
                    <div className="text-center mb-3">
                      <div className="inline-block">
                        <div className={`text-3xl font-black ${paceSplitDifference < 0 ? 'text-green-400' : paceSplitDifference > 0 ? 'text-orange-400' : 'text-cyan-400'}`}>
                          {paceSplitDifference > 0 ? '+' : ''}{paceSplitDifference}
                        </div>
                        <div className="text-xs text-cyan-400 font-semibold mt-1">seconds per km difference</div>
                      </div>
                    </div>
                    <input
                      type="range"
                    ...
                    <div className="flex justify-between text-xs text-neutral-400 mt-2 font-semibold">
                      ...
                      <span className="text-cyan-400">Even</span>
                  ...
                  <div className="bg-neutral-900/50 rounded-lg p-3 border border-cyan-500/20">
                    ...
                    <div className="flex items-baseline gap-2">
                      <input
                        ...
                        className="input-field flex-1 text-xl font-bold text-cyan-300 bg-neutral-950 border-cyan-500/50 focus:border-cyan-400"
                        placeholder="0"
                      />
                      <span className="text-sm font-semibold text-cyan-400">meters</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/5 border-2 border-rose-400/30 rounded-xl p-5 shadow-lg">
                <h3 className="text-base font-black text-rose-300 mb-1 uppercase tracking-wide flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-rose-400 animate-pulse"></span>
                  Heart Rate Data
                </h3>
                <p className="text-xs text-rose-300/60 mb-4">Optional but recommended for accurate zone calibration</p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-neutral-900/50 rounded-lg p-3 border border-rose-500/20">
                    <label className="text-xs font-bold text-rose-400 mb-2 block uppercase tracking-wider">
                      Starting Heart Rate
                    </label>
                    ...
                    <div className="flex items-baseline gap-2">
                      <input
                        ...
                        className="input-field flex-1 text-xl font-bold text-rose-300 bg-neutral-950 border-rose-500/50 focus:border-rose-400"
                        placeholder="0"
                      />
                      <span className="text-sm font-semibold text-rose-400">bpm</span>
                    </div>
                  </div>
              ...
              <div className="bg-blue-500/5 border-2 border-blue-400/30 rounded-xl p-5 shadow-lg">
                <h3 className="text-base font-black text-blue-300 mb-4 uppercase tracking-wide flex items-center gap-2">
                ...
                <div className="space-y-4">
                  <div className="bg-neutral-900/50 rounded-lg p-4 border border-blue-500/20">
                    <label className="text-sm font-bold text-blue-300 mb-4 block">
                  ...
                  <div className="bg-neutral-900/50 rounded-lg p-4 border border-blue-500/20">
                    ...
                    <div className="mb-4">
                      <div className="text-center mb-3">
                        <div className="inline-flex items-center gap-3 px-6 py-3 bg-neutral-950 rounded-xl border-2 border-blue-400/50">
                          <span className={`text-4xl font-black ${
                            effortConsistency === 0 ? 'text-neutral-600' :
                            effortConsistency <= 3 ? 'text-orange-400' :
                            effortConsistency <= 6 ? 'text-amber-400' :
                            effortConsistency <= 8 ? 'text-cyan-400' :
                            'text-green-400'
                          }`}>
                            {effortConsistency === 0 ? '--' : effortConsistency}
                          </span>
                          <span className="text-sm text-blue-400 font-bold">/ 10</span>
                        </div>
                      </div>
                      <input
                        type="range"
                      ...
                      <div className="flex justify-between text-xs text-neutral-400 mt-3 font-semibold">
                        ...
                        <span className="text-cyan-400">Pretty Steady</span>
              ...
              <div className="bg-neutral-900/30 border border-neutral-700/50 rounded-xl p-5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="input-field resize-none text-sm w-full bg-neutral-950 border-neutral-700 focus:border-neutral-500"
                />
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-8 pt-6 border-t-2 border-teal-500/20">
              <button
                onClick={onClose}
                className="flex-1 px-6 py-4 border-2 border-neutral-600 text-neutral-300 rounded-xl hover:border-neutral-500 hover:bg-neutral-800/50 transition-all font-bold text-base uppercase tracking-wide"
              >
                Cancel
              </button>
              <button
