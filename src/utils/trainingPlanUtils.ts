...
export const getTodayInfo = (planStartDate?: string) => {
  const now = new Date();
...
export const convertRPEtoEffort = (text: string, isBeginnerPlan: boolean, weekNumber?: number): string => {
  if (isBeginnerPlan) {
    return text
...
export const getTimeProgress = (planStartDate?: string, raceDate?: string) => {
