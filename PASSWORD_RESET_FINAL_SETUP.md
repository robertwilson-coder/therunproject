...
For emails to be sent from `noreply@therunproject.com`, you need to verify your domain.
...
4. Once verified, you'll see a green checkmark next to `therunproject.com`
...
4. ⏳ **You need to**: Verify therunproject.com domain in Resend
